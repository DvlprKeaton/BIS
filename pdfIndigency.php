...
echo "<h1 style = text-align:center; >Certificate of Indigency<br><br></h1>";
echo '<p>OR NUMBER: '.$ORNUMBER = $OR.$currentDate. '-' . $editlname_resident.'</p>';
 echo "<h3>TO WHOM IT MAY CONCERN, </h3><br>";

echo "<p class = paragraph>This is to certify that <b>".$editfname_resident." ".$editmname_resident." ".$editlname_resident." ".$editsuffix_resident." </b> is permanently residing at Barangay Dadalaquiten Sur, Sinait, Ilocos Sur belong to the ultra- poor families of this barangay.<p>";
echo "<p class = paragraph>This Certification is issued upon the request of the above name for whatever purposes it may serve.<br><br> Issued this <b>".$currentDate."</b>.<p>";
...
<div class="mb-3">
	...
	<button class="btn btn-danger" type="cancel" onclick="window.location='indigency.php';return false;">Cancel</button>
</div>
<style type="text/css">
