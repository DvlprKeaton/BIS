				...
				<thead>
					...
					while ($results = mysqli_fetch_array($result)) { ?>
						...
						<tr>
							...
							<td>
								<form action="pdfIndigency.php" method="post">
							...
							<form action="uploadIndigency.php" method="post" enctype="multipart/form-data">
					<td>
						<input hidden type="text" name="ID" value="<?php echo $results ['id_resident'] ?>">
						<label>
                        <label for="myfile">Upload Certificate of Indigency:</label>
                        <br>
