						...
						<tr>
							...
							<td>
								<form action="validate.php" method="post">
									...
									<?php
									 if ($row>0) {
                        if ($results['voter_status'] == '0') {
									?>
									<button type="submit" class="btn btn-primary" name="delete"><i class="fa fa-check"></i></button>
									<?php
								}else if ($results['voter_status'] == 'Validated') {
									echo'<button type="submit" class="btn btn-primary" name="delete" disabled="true"><i class="fa fa-check"></i></button>';
								}else

								{
									...
									?>
									<button type="submit" class="btn btn-primary" name="delete" disabled="true"><i class="fa fa-check"></i></button>
									<?php
								}
								?>
									<input type="hidden" name="deleteId" value="<?php echo $results['id_resident']?>">
								</form>
							</td>
							<td>
