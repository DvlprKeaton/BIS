  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
      <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <span class="badge badge-danger badge-counter"> <?php echo $row + $row2; ?></span>
      </a>
      ...
      <a class="dropdown-item d-flex align-items-center" href="#">
          <?php
              ...
              $sql2 = "SELECT * FROM locations WHERE request=2"; 
              $result2= mysqli_query($cn,$sql2);
              $row2= mysqli_num_rows($result2);

            
            if ($row= mysqli_num_rows($result)>0 || $row2= mysqli_num_rows($result2)>0)
             {
              ...
              {
                 echo '<a class= "dropdown-item text-primary font-weight-bold" href= "map.php?id='.$res2['id'].'">A pin request is confirmed!</a>';
                 echo '<div class= "dropdown-divider"></div>';
              }
            }
            else{
