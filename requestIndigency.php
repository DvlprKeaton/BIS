...
$row = mysqli_fetch_array($res);
	...
	$logtime = date("d/m/Y - l - h:i:sa");
		...
		$sql2 = "INSERT INTO `tbl_msg`(`sender_id`, `sender_name`, `message`, `msg_status`, `msg_date`,`IndiRequest`,`Status`,`RequestType`) VALUES ('$logid','$fname','Hello, I want to request for a Certificate of Indigency','1','$logtime','1','1','Indigency')";
