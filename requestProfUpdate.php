...
$row = mysqli_fetch_array($res);
	...
	$sql2 = "INSERT INTO `tbl_msg`(`sender_id`, `sender_name`, `message`, `msg_status`, `msg_date`,`ProfRequest`,`Status`,`RequestType`) VALUES ('$logid','$fname','Hello, I want to update my profile','1','$logtime','1','1','Profile')";
